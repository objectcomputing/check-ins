...
const SelfReviewPage = () => {
  ...
  return (
    <Root className={classes.root}>
      { !selectedPeriod && (<div className={classes.headerContainer}>
        <Typography className={classes.requestHeader} variant="h4">Self-Reviews for <b>{memberProfile?.firstName+" "+memberProfile?.lastName}</b></Typography>
      </div>) }
