  ...
  const defaultMarks = [
    {
      ...
      label: 'Interested',
      tooltip:
        'You have an interest in this skill and, perhaps, common knowledge or an understanding of its basic techniques and concepts.',
      tooltipChildren: ['Focus on learning.']
    },
    {
      value: 2,
      label: 'Novice',
      tooltip:
        'You have the level of experience gained in a classroom, experimental scenarios, or via other training. You are expected to need help when performing this skill.',
      tooltipChildren: [
    ...
    },
    {
      ...
      label: 'Expert',
      tooltip:
        'You are known as an expert in this area. You can provide guidance, troubleshoot and answer questions related to this skill.',
      tooltipChildren: [
