          ...
          <TableRow>
            <TableCell>
              <Autocomplete
                ...
                renderInput={(params) => <TextField {...params} label="Find a permission" variant="outlined" />}
              />
            </TableCell>
          ...
          {matchedPermission?
            <TableRow key={matchedPermission}>
              ...
              <TableCell key={selectedRole.id} align="right">
                <Checkbox 
                  checked={selectedRole.permissions.indexOf(matchedPermission) !== -1? true : false}
          ...
          :
            allPermissions.map(permission => (
              <TableRow key={permission}>
                ...
                <TableCell key={selectedRole.id} align="right">
                    <Checkbox 
                      checked={selectedRole.permissions.indexOf(permission) !== -1? true : false}
