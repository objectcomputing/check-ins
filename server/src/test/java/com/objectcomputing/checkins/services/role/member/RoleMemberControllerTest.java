...
class RoleMemberControllerTest extends TestContainersSuite implements RoleFixture, MemberProfileFixture, RoleMemberFixture {
    ...
    void testCreateARoleMemberByAdmin() {
        ...
        RoleMemberCreateDTO roleMemberCreateDTO = new RoleMemberCreateDTO(role.getId(), memberProfile.getId());
    ...
    void testCreateAnInvalidRoleMember() {
        RoleMemberCreateDTO dto = new RoleMemberCreateDTO(null, null);
    ...
    void testCreateARoleMemberWithNonExistingRole() {
        ...
        RoleMemberCreateDTO roleMemberResponseDTO = new RoleMemberCreateDTO(UUID.randomUUID(), memberProfile.getId());
    ...
    void testCreateARoleMemberWithNonExistingMember() {
        ...
        RoleMemberCreateDTO requestDTO = new RoleMemberCreateDTO(role.getId(), UUID.randomUUID());
    ...
    void testCreateARoleMemberWithExistingMemberAndRole() {
        ...
        RoleMemberCreateDTO roleMemberResponseDTO = new RoleMemberCreateDTO(roleMember.getRoleId(), memberProfile.getId());
    ...
    void testUpdateRoleMemberByAdmin() {
        ...
        RoleMemberUpdateDTO roleMemberUpdateDTO = new RoleMemberUpdateDTO(roleMember.getId(), roleMember.getRoleId(), roleMember.getMemberId());
