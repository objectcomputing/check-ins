...
public interface OnboardingFixture extends RepositoryFixture {
    default Mono<OnboardingProfile> createADefaultOnboardeeProfile(BackgroundInformation backgroundInformation) {
    ...
    default Mono<OnboardingProfile> createSecondOnboardeeProfile(BackgroundInformation backgroundInformation) {
