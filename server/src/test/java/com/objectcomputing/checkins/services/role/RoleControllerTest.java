...
class RoleControllerTest extends TestContainersSuite implements RoleFixture, MemberProfileFixture, RoleMemberFixture {
    ...
    void testCreateARole() {
        ...
        roleCreateDTO.setRoleMembers(List.of(new RoleCreateDTO.RoleMemberCreateDTO(memberProfile.getId())));
    ...
    void testCreateRoleNoLeads() {
        ...
        assertEquals("Role must include at least one role member", errors.asText());
