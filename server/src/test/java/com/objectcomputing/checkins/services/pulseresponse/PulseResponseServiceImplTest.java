...
public class PulseResponseServiceImplTest {
    ...
    @Test
    void testRead() {
        PulseResponse cd = new PulseResponse(UUID.randomUUID(),LocalDate.of(2019, 1, 01),UUID.randomUUID(),"examplePRId" , "examplePRId2");
    ...
    @Test
    void testSave() {
        PulseResponse cd = new PulseResponse(LocalDate.of(2019, 1, 01),UUID.randomUUID(), "PRId", "PRId2");
    ...
    @Test
    void testSaveWithId() {
        PulseResponse cd = new PulseResponse(UUID.randomUUID(),LocalDate.of(2019, 1, 01), UUID.randomUUID(), "PRId", "PRId2");
    ...
    void testSavePulseResponseNullTeamMemberId() {
        PulseResponse cd = new PulseResponse(LocalDate.of(2019, 1, 01),null, "PRId", "PRId2");
    ...
    void testSavePulseResponseNullPRId() {
        PulseResponse cd = new PulseResponse(LocalDate.of(2019, 1, 01), UUID.randomUUID(), null, null);
