...
public class Opportunities {
    ...
    public Opportunities(UUID id,LocalDate submittedOn, UUID submittedBy, String name, String description) {
        this.id = id;
    ...
    public Opportunities(LocalDate submittedOn, UUID submittedBy, String name, String description) {
        this(null,submittedOn, submittedBy, name, description);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, description, submittedOn, submittedBy);
    }
}
...
//
//    public Opportunities(UUID id, LocalDate expiresOn, LocalDate submittedOn, UUID submittedBy, String name, String description, String url, Boolean pending) {
//        this.id = id;
...
//    }
//
//    public Opportunities(LocalDate expiresOn, LocalDate submittedOn, UUID submittedBy, String name, String description, String url, Boolean pending) {
//        this(null,expiresOn, submittedOn, submittedBy, name, description, url, pending);
//    }
//
//    public UUID getId() {
//        return this.id;
