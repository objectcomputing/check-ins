...
public class LoginAccount implements Identifiable, Account {
    ...
    public LoginAccount(UUID id, String emailAddress, AccountState state, AccountRole role, Instant currentInstant, LocalUserCredentials localUserCredentials) {
        this(emailAddress, state, role, currentInstant, localUserCredentials);
