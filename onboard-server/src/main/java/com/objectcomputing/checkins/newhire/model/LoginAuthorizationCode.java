...
public class LoginAuthorizationCode {
    ...
    public LoginAuthorizationCode(LoginAccount loginAccount, String salt, String verifier, LoginAuthorizationPurpose purpose, Instant issuedInstant, TimeToLive timeToLive) {
        this();
